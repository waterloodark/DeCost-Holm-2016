plot(function(x){
  return(dlnorm(x,meanlog=(log(0.1)-0.5^2/2),sdlog=0.5))
},xlim=c(0,0.6))
...
plot(function(x){
  return(dlnorm(x,meanlog=(log(0.1)-0.6^2/2),sdlog=0.6))
},xlim=c(0,0.6),add=TRUE)

plot(function(x){
  return(dnorm(x,mean=0.1,sd=0.025))
},xlim=c(0,0.6),add=TRUE)

plot(function(x){
  return(dlnorm(x,meanlog=(log(0.1)-0.25^2/2),sdlog=0.25))
},xlim=c(0,0.6),add=TRUE)

plot(function(x){
  return(dlnorm(x,meanlog=(log(0.12)-0.5^2/2),sdlog=0.5))
},xlim=c(0,0.6),add=TRUE)

plot(function(x){
  return(dlnorm(x,meanlog=(log(0.12)-0.6^2/2),sdlog=0.6))
},xlim=c(0,0.6),add=TRUE)
...
plot(function(x){
  return(dweibull(x,shape=m,scale=eta))
},xlim=c(0,0.6),add=TRUE)
